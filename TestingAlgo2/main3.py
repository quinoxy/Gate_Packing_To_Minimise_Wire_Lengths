...
for i in range(6):
    ...
    fileout = 'output_aadi/output' + str(i)+'.txt'
    # Measure the time taken to solve each test case
    start = time.time()
    obj , length ,bounding_box = aadi_solution(filename)
    obj.send_to_file(fileout)  
    end = time.time()
...
plt.grid(True)
plt.legend()
plt.savefig("graphs_aadi/time_taken_vs_number_of_wires.png")  # Save the first graph
plt.close()
...
plt.grid(True)
plt.legend()
plt.savefig("graphs_aadi/wire_length_vs_number_of_wires.png")  # Save the second graph
plt.close()
x = []
y1 = []
y2 = []
...
plt.grid(True)
plt.legend()
plt.savefig("graphs_aadi/time_taken_vs_number_of_gates.png")  # Save the first graph
plt.close()
...
plt.grid(True)
plt.legend()
plt.savefig("graphs_aadi/wire_length_vs_number_of_gates.png")  # Save the second graph
plt.close()
...
plt.grid(True)
plt.legend()
plt.savefig("graphs_aadi/time_taken_vs_number_of_pins.png")  # Save the first graph
plt.close()
...
plt.grid(True)
plt.legend()
plt.savefig("graphs_aadi/wire_length_vs_number_of_pins.png")  # Save the second graph
plt.close()
x = []
y1 = []
y2 = []
...
plt.grid(True)
plt.legend()
plt.savefig("graphs_aadi/time_taken_vs_avg_size_of_gates.png")  # Save the first graph
plt.close()
...
plt.grid(True)
plt.legend()
plt.savefig("graphs_aadi/wire_length_vs_avg_size_of_gates.png")  # Save the second graph
plt.close()